...
from orc.optimal_control.cost_functions_marco import OCPFinalCostState, OCPFinalCostFramePos, OCPFinalCostFrame
from orc.optimal_control.cost_functions_marco import OCPRunningCostQuadraticJointVel, OCPRunningCostQuadraticJointAcc, OCPRunningCostQuadraticControl
from orc.optimal_control.inequality_constraints_marco import OCPFinalPlaneCollisionAvoidance, OCPPathPlaneCollisionAvoidance
from orc.optimal_control.inequality_constraints_marco import OCPFinalJointBounds, OCPPathJointBounds
from orc.optimal_control.inequality_constraints_marco import OCPFinalSelfCollisionAvoidance, OCPPathSelfCollisionAvoidance
