...
def backward_pass(solver, X_bar, U_bar, mu):
        ...
        for i in range(N-1, -1, -1):
            ...
            V_x[i,:]    =   solver.Q_x[i,:] + solver.K[i,:,:].T @ solver.Q_u[i,:] + solver.K[i,:,:].T @ solver.Q_uu[i,:,:] @ solver.w[i,:] + solver.Q_xu[i,:,:] @ solver.w[i,:]
            V_xx[i,:]   =   solver.Q_xx[i,:,:] + solver.K[i,:,:].T @ solver.Q_uu[i,:,:] @ solver.K[i,:,:] + solver.K[i,:,:].T @ solver.Q_xu[i,:,:].T + solver.Q_xu[i,:,:] @ solver.K[i,:,:]
