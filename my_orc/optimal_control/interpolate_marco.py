...
# Used to interpolate various trajectories together, the pause may be useful to wait for example for the gripper to open and close
# It interpolates the trajectory given by Optimal Control Problem and gives a trajectory with a much finer step, here dt = 0.001 s (1ms) meanwhile the OCP gives a point every 20ms.    
